...
a persistence unit "2641archPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "2641arch\pom.xml":
...
artifact ("2641arch.war") is already built. You can build
